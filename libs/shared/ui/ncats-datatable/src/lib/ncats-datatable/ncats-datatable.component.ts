 ...
 */
export class NcatsDatatableComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  fetchTableFields(): void {
    ...
    if (this.selectableRows) {
      this.displayColumns = ['select'].concat(this.displayFields.map(field => field.field));
      this.ref.detectChanges();
    } else {
